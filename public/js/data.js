...
var g = {
  ...
  methods: {
    set_cur_pool: function set_cur_pool() {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('./set_cur_pool', {
...
(0,vue__WEBPACK_IMPORTED_MODULE_1__.createApp)(g).mount('#simu_data');
})();
